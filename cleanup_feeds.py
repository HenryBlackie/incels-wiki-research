...
with open('feeds/nodes.csv', 'r',
          encoding='utf-8') as infile, open('feeds/cleaned_nodes.csv',
                                            'w',
...
with open('feeds/edges.csv', 'r',
          encoding='utf-8') as infile, open('feeds/cleaned_edges.csv',
                                            'w',
                                            encoding='utf-8') as outfile:
    for line in infile:
        if line.strip() != ',':
